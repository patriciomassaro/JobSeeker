...
\begin{itemize}
    \item Solved complex problems using Machine Learning to develop early detection algorithms, addressing data quality issues by reducing the spam rate by 30%.
...
\begin{itemize}
    \item Applied Machine Learning using GANs in Pytorch across remote-sensing sectors, creating robust solutions that achieved a 20% error reduction in land surface temperature estimation for wildfire management.
