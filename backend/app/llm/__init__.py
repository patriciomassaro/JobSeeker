    ...
    def initialize_model(self):
        if "gpt" in self.model_name:
            if OPENAI_API_KEY and (
                ...
                or self.model_name == "gpt-4-turbo-2024-04-09"
        ...
        elif GROQ_API_KEY and (
            self.model_name == "llama3-70b-8192" or self.model_name == "llama3-8b-8192"
        ):
            self.llm = ChatGroq(
...
if __name__ == "__main__":
    llm_init = LLMInitializer(model_name=ModelNames.GPT3_TURBO.value, temperature=0.3)
